      ...
      {allArticles.map((article, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="aspect-[4/3] rounded-xl overflow-hidden mb-4 bg-[#e8ebe3]">
              <img 
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML = '<div class="w-full h-full flex items-center justify-center"><div class="w-10 h-10 rounded-lg bg-[#c5d0c5] flex items-center justify-center"><div class="w-4 h-4 bg-[#f8f9f5] rounded-sm"></div></div></div>';
                }}
              />
            </div>
            ...
            <Link 
              to={isArticle05 ? "/articles/broken-link-404" : `/articles/${article.name}`} 
              className="mt-auto"
            >
